...
## [0.5.0-alpha.1](https://github.com/hop-top/poly-kit/compare/kit-py/v0.5.0-alpha.1...kit-py/v0.5.0-alpha.1) (2026-06-07)

The hop-top team is happy to announce Kit's Python SDK 0.5.0-alpha.1. This release includes maintenance release with bug fixes.
...
Full diff: [kit-py/v0.5.0-alpha.1...kit-py/v0.5.0-alpha.1](https://github.com/hop-top/poly-kit/compare/kit-py/v0.5.0-alpha.1...kit-py/v0.5.0-alpha.1)
