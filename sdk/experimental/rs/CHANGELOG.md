...
The hop-top team is happy to announce Kit's Rust SDK 0.5.0-alpha.0. This release includes miscellaneous improvements.
...
Full diff: [kit-rs/v0.4.0-experimental.3...kit-rs/v0.5.0-alpha.0](https://github.com/hop-top/poly-kit/compare/kit-rs/v0.4.0-experimental.3...kit-rs/v0.5.0-alpha.0)
