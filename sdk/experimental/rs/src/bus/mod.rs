...
//! adapter. Neither is ported. See ADR 0004 in the repo's `docs/adr/`
//! for the rationale and for what to build instead should cross-process
//! eventing become a real requirement.
//!
