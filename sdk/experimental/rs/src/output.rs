...
pub use error::{
    ...
    CODE_NOT_FOUND, CODE_OK, CODE_PREREQUISITE, CODE_PROVENANCE_MISSING, CODE_RATE_LIMITED,
    CODE_TRANSIENT, CODE_UNAUTHORIZED, CODE_USAGE, EXIT_CONSENT_REFUSED, EXIT_GENERIC,
    EXIT_PREREQUISITE, EXIT_PROVENANCE_MISSING, EXIT_RATE_LIMITED, EXIT_TRANSIENT,
