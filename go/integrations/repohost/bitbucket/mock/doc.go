// Package mock implements a unit-test mock driver for the Bitbucket
// repohost surface. It registers itself under provider name
// "bitbucket-mock" so adopter tests can blank-import this package and
// switch by setting Config.Provider = "bitbucket-mock".
//
