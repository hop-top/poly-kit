...
type HealthCheckResponse struct {
	state         protoimpl.MessageState            `protogen:"open.v1"`
	Status        HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=routellm.v1.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\vroutellm.v1\".\n" +
	"\x12HealthCheckRequest\x12\x18\n" +
	"\aservice\x18\x01 \x01(\tR\aservice\"\xda\x01\n" +
	"\x13HealthCheckResponse\x12F\n" +
	"\x06status\x18\x01 \x01(\x0e2..routellm.v1.HealthCheckResponse.ServingStatusR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x0euptime_seconds\x18\x03 \x01(\x03R\ruptimeSeconds\":\n" +
	"\rServingStatus\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aSERVING\x10\x01\x12\x0f\n" +
	"\vNOT_SERVING\x10\x022\xa9\x01\n" +
	"\rHealthService\x12J\n" +
	"\x05Check\x12\x1f.routellm.v1.HealthCheckRequest\x1a .routellm.v1.HealthCheckResponse\x12L\n" +
	"\x05Watch\x12\x1f.routellm.v1.HealthCheckRequest\x1a .routellm.v1.HealthCheckResponse0\x01B\x9f\x01\n" +
	"\x0fcom.routellm.v1B\vHealthProtoP\x01Z2hop.top/kit/contracts/proto/routellm/v1;routellmv1\xa2\x02\x03RXX\xaa\x02\vRoutellm.V1\xca\x02\vRoutellm\\V1\xe2\x02\x17Routellm\\V1\\GPBMetadata\xea\x02\fRoutellm::V1b\x06proto3"
...
var file_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: routellm.v1.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: routellm.v1.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: routellm.v1.HealthCheckResponse
}
var file_health_proto_depIdxs = []int32{
	0, // 0: routellm.v1.HealthCheckResponse.status:type_name -> routellm.v1.HealthCheckResponse.ServingStatus
	1, // 1: routellm.v1.HealthService.Check:input_type -> routellm.v1.HealthCheckRequest
	1, // 2: routellm.v1.HealthService.Watch:input_type -> routellm.v1.HealthCheckRequest
	2, // 3: routellm.v1.HealthService.Check:output_type -> routellm.v1.HealthCheckResponse
	2, // 4: routellm.v1.HealthService.Watch:output_type -> routellm.v1.HealthCheckResponse
