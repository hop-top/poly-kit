...
| 0004 | [Rust SDK omits distributed backends](./0004-rust-sdk-omits-distributed-backends.md) <a id="0004-rust-sdk-omits-distributed-backends"></a> | Accepted | Port subsystem cores to Rust without their cross-process backends: bus `NetworkAdapter`, kv etcd/TiDB, blob S3. Prefer a Unix-socket or SQLite adapter if cross-process eventing is ever needed. |
