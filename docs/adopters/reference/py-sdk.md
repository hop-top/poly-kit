...
Python authors who already have `hop-top-kit` installed and need the
detail the package front page links out to. For the CLI factory itself
see [`py-api-reference.md`](py-api-reference.md).
